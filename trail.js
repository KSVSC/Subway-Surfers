...
var keyboard = {};
var player = { height: 1.0, speed: 1.5, zspeed: 0.5, yspeed:0.1, turnSpeed: 0.5};
...
function onResourcesLoaded() {
    ...
    // Train[0].position.set(2.25, 0, 95);
    // Train[1].position.set(-1.54, 0, 620);
    // for (i = 0; i < 2; i++) {
    //     scene.add(Train[i]);
